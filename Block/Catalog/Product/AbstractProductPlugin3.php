...
class AbstractProductPlugin3
{
    ...
    public function beforeGetAddToCartUrl(
        ...
        $this->logger->log('Plugin3 - beforeGetAddToCartUrl', null, 'plugin.log');
    }
    ...
    public function afterGetAddToCartUrl(
        ...
        $this->logger->log('Plugin3 - afterGetAddToCartUrl', null, 'plugin.log');
    ...
    public function aroundGetAddToCartUrl(
        ...
        $this->logger->log('Plugin3 - aroundGetAddToCartUrl', null, 'plugin.log');
